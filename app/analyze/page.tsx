      ...
      <main className="max-w-3xl mx-auto px-5 pt-8 pb-20">
        ...
        {step === 'blood' && (
          <div className="anim-fade-up delay-1">
            ...
            >
              <div className="p-6 sm:p-8">
                <BloodReportUploader onMarkersExtracted={handleUploadMarkersExtracted} />
                <p className="mt-3 text-xs" style={{ color: 'var(--text-tertiary)' }}>
                  We prefill the values we can extract. Review/edit below, then press Analyze Blood Values.
                </p>
              </div>
            </div>
